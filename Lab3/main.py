...
from sklearn.metrics import accuracy_score, precision_recall_curve,precision_score,recall_score,roc_curve,auc\
    ,average_precision_score,RocCurveDisplay,PrecisionRecallDisplay,roc_auc_score
